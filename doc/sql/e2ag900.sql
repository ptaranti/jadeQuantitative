-- CREATE TABLE behaviourregisterexp2a900
-- (
...
-- COPY behaviourregisterexp2a900 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-900/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a900 where (simulationtime > 65000);
