-- CREATE TABLE behaviourregisterexp2a300
-- (
...
-- COPY behaviourregisterexp2a300 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-300/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a300 where (simulationtime > 65000);
