-- CREATE TABLE behaviourregisterexp2a700
-- (
...
-- COPY behaviourregisterexp2a700 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-700/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a700 where (simulationtime > 65000);
