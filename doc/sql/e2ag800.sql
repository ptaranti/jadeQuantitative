-- CREATE TABLE behaviourregisterexp2a800
-- (
...
-- COPY behaviourregisterexp2a800 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-800/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a800 where (simulationtime > 65000);
