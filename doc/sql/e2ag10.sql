-- CREATE TABLE behaviourregisterexp2a10
-- (
...
-- COPY behaviourregisterexp2a10 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-10/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
-- 
...
-- FROM behaviourregisterexp2a10 where (simulationtime > 65000);
-- 
