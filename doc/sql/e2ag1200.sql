-- CREATE TABLE behaviourregisterexp2a1200
-- (
...
-- COPY behaviourregisterexp2a1200 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1200/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
-- 
...
-- FROM behaviourregisterexp2a1200 where (simulationtime > 65000);
