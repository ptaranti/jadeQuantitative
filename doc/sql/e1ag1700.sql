-- CREATE TABLE behaviourregisterexp1a1700
-- (
...
-- COPY behaviourregisterexp1a1700 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/PrimeiroExperimento/Agentes-1700/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
FROM behaviourregisterexp1a1700 where (simulationtime > 65000);
