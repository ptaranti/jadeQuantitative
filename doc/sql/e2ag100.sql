-- CREATE TABLE behaviourregisterexp2a100
-- (
...
-- COPY behaviourregisterexp2a100 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-100/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a100 where (simulationtime > 65000);
