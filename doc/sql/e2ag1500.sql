-- CREATE TABLE behaviourregisterexp2a1500
-- (
...
-- COPY behaviourregisterexp2a1500 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1500/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a1500 where (simulationtime > 65000);
