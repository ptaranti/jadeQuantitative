-- CREATE TABLE behaviourregisterexp2a1700
-- (
...
-- COPY behaviourregisterexp2a1700 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1700/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a1700 where (simulationtime > 65000);
