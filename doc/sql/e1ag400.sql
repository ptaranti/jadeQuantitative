-- CREATE TABLE behaviourregisterexp2a400
-- (
...
-- COPY behaviourregisterexp2a400 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-400/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a400 where (simulationtime > 65000);
