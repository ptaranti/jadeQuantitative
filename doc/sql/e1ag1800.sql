-- CREATE TABLE behaviourregisterexp1a1800
-- (
...
-- COPY behaviourregisterexp1a1800 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/PrimeiroExperimento/Agentes-1800/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
FROM behaviourregisterexp1a1800 where (simulationtime > 65000);
