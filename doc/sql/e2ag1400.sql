-- CREATE TABLE behaviourregisterexp2a1400
-- (
...
-- COPY behaviourregisterexp2a1400 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1400/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a1400 where (simulationtime > 65000);
