-- CREATE TABLE behaviourregisterexp1a1900
-- (
...
-- COPY behaviourregisterexp1a1900 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/PrimeiroExperimento/Agentes-1900/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
-- 
...
-- FROM behaviourregisterexp1a1900 where (simulationtime > 65000);
