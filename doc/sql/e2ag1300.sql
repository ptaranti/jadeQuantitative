-- CREATE TABLE behaviourregisterexp2a1300
-- (
...
-- COPY behaviourregisterexp2a1300 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1300/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a1300 where (simulationtime > 65000);
