-- CREATE TABLE behaviourregisterexp2a1800
-- (
...
-- COPY behaviourregisterexp2a1800 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1800/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a1800 where (simulationtime > 65000);
