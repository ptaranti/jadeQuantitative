-- CREATE TABLE behaviourregisterexp2a1900
-- (
...
-- COPY behaviourregisterexp2a1900 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1900/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
FROM behaviourregisterexp2a1900 where (simulationtime > 65000);
