-- CREATE TABLE behaviourregisterexp2a1600
-- (
...
-- COPY behaviourregisterexp2a1600 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1600/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a1600 where (simulationtime > 65000);
