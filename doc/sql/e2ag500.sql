-- CREATE TABLE behaviourregisterexp2a500
-- (
...
-- COPY behaviourregisterexp2a500 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-500/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a500 where (simulationtime > 65000);
