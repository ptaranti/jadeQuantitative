-- CREATE TABLE behaviourregisterexp2a200
-- (
...
-- COPY behaviourregisterexp2a200 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-200/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a200 where (simulationtime > 65000);
