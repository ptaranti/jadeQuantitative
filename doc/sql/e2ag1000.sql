-- CREATE TABLE behaviourregisterexp2a1000
-- (
...
-- COPY behaviourregisterexp2a1000 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1000/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a1000 where (simulationtime > 65000);
