-- CREATE TABLE behaviourregisterexp1a1500
-- (
...
-- COPY behaviourregisterexp1a1500 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/PrimeiroExperimento/Agentes-1500/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp1a1500 where (simulationtime > 65000);
