-- CREATE TABLE behaviourregisterexp2a1100
-- (
...
-- COPY behaviourregisterexp2a1100 
-- FROM 
-- '/trabalho/Trabalho/PUC-Rio/Doutorado/Disciplinas/2010.2/Qualificacao/SegundoExperimento/Agentes-1100/BehaviourRegister.csv' 
-- CSV QUOTE '"' delimiter ';';
...
-- FROM behaviourregisterexp2a1100 where (simulationtime > 65000);
